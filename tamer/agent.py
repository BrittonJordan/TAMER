...
class SGDFunctionApproximator:
    ...
    def __init__(self, env):
        ...
        for _ in range(env.action_space.n):
            ...
            model.partial_fit([self.featurize_state(self._reset_obs(env))], [0])
            self.models.append(model)

    @staticmethod
    def _reset_obs(env):
        """Handle Gym API differences: reset() can return obs or (obs, info)."""
...
class Tamer:
    ...
    def _step_env(self, action):
        """Handle Gym API differences across versions."""
